...
#define DRIVER_NAMESPACE(inst, name) _CONCAT(name, inst)
...
#define DRIVER_DEFINE(inst)                                                                                            \
    ...
    PM_DEVICE_DT_INST_DEFINE(inst, driver_pm_action);                                                                  \
                                                                                                                       \
    DEVICE_DT_INST_DEFINE(inst, driver_init, PM_DEVICE_DT_INST_GET(inst), &DRIVER_NAMESPACE(inst, data),               \
                          &DRIVER_NAMESPACE(inst, config), POST_KERNEL, CONFIG_ZEPHYR_MODEM_UART_INIT_PRIORITY, NULL);
